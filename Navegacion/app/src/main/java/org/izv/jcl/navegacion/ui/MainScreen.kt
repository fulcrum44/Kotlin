package org.izv.jcl.navegacion.ui
...
import org.izv.jcl.navegacion.data.Contact
import org.izv.jcl.navegacion.ui.theme.NavegacionTheme
...
fun SearchContactScreen(navController: NavHostController, contactos: MutableList<Contact>) {
    ...
    Column(
        ...
        OutlinedTextField(
            value = consultaTlf,
            onValueChange = { consultaTlf = it },
            label = { Text("Buscar nº teléfono") },
            modifier = Modifier.fillMaxWidth()
        )
        Spacer(modifier = Modifier.height(16.dp))
